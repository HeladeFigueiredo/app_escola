...
class ChatProfessoraView extends GetView<ChatProfessoraController> {
  const ChatProfessoraView({Key? key}) : super(key: key);
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Envei uma mensagem para a professora responsável',
                    textAlign: TextAlign.center,
